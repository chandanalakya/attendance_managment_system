...
def test_faculty_login_success(monkeypatch):
    ...
    monkeypatch.setattr(faculty_module, "find_user_by_email", lambda email: mock_user)
    monkeypatch.setattr(faculty_module, "verify_password", lambda pw, pw_hash: True)
...
def test_faculty_login_fail(monkeypatch):
    ...
    monkeypatch.setattr(faculty_module, "find_user_by_email", lambda email: mock_user)
    monkeypatch.setattr(faculty_module, "verify_password", lambda pw, pw_hash: False)
